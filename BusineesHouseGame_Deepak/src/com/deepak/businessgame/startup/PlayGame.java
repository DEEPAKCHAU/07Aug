package com.deepak.businessgame.startup;

import com.deepak.businessgame.exception.InsufficientFundsException;
import com.deepak.businessgame.model.*;
import com.deepak.businessgame.service.GameService;
import com.deepak.businessgame.serviceImpl.GameServiceImpl;
    ...
    public static void main(String[] args) {
        ...
        for (int turn = 1; turn <= 7; turn++) {
            for (Player player : players) {
                ...
                // because we have total 10 cells
                if (targetCellIndex > 9) {
                    // for Circular rotation of cells
