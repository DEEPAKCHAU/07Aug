package com.deepak.businessgame.serviceImpl;
...
public class GameServiceImpl implements GameService {
    ...
    public List<Player> setupPlayers(int numberOfPlayer) {
        ...
        players.add(new Player("player1", 1, 1000, 0, new ArrayList<>()));
        players.add(new Player("player2", 2, 1000, 0, new ArrayList<>()));
        players.add(new Player("player3", 3, 1000, 0, new ArrayList<>()));
